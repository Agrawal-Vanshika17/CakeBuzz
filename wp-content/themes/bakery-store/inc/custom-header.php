...
function bakerystore_header_style() {
	...
	$header_menucolor = esc_attr(get_theme_mod('header_menucolor','#fff'));
	$header_menuhovercolor = esc_attr(get_theme_mod('header_menuhovercolor','#FBFA02'));
	$header_menuarrowcolor = esc_attr(get_theme_mod('header_menuarrowcolor','#fff'));
	$header_submenucolor = esc_attr(get_theme_mod('header_submenucolor','#fff'));
	$header_submenuhovercolor = esc_attr(get_theme_mod('header_submenuhovercolor','#FBFA02'));
	$header_submenubgcolor = esc_attr(get_theme_mod('header_submenubgcolor','#FD67BE'));
	$header_submenubordercolor = esc_attr(get_theme_mod('header_submenubordercolor','#fff'));
  	...
  	$slider_slidebarcolor = esc_attr(get_theme_mod('slider_slidebarcolor','#FDDD18'));
  	$slider_slidebaractivecolor = esc_attr(get_theme_mod('slider_slidebaractivecolor','#bb8fe7'));
  	...
  	$footer_bg_col = esc_attr(get_theme_mod('footer_bg_col','#bb8fe7'));
  	$footer_heading_col = esc_attr(get_theme_mod('footer_heading_col','#fff'));
  	$footer_text_col = esc_attr(get_theme_mod('footer_text_col','#fff'));
  	$footer_list_col = esc_attr(get_theme_mod('footer_list_col','#fff'));
  	$footer_icon_col = esc_attr(get_theme_mod('footer_icon_col','#fff'));
  	$footer_listhover_col = esc_attr(get_theme_mod('footer_listhover_col','#FBFA02'));
  	$footer_copyright_col = esc_attr(get_theme_mod('footer_copyright_col','#fff'));
  	$footer_copyrightlink_col = esc_attr(get_theme_mod('footer_copyrightlink_col','#FBFA02'));
  	$footer_topborder_col = esc_attr(get_theme_mod('footer_topborder_col','#fff'));
  	$footer_scrolltoparrow_col = esc_attr(get_theme_mod('footer_scrolltoparrow_col','#fff'));
  	$footer_scrolltopbg_col = esc_attr(get_theme_mod('footer_scrolltopbg_col','#FD67BE'));
  	$footer_scrolltopbghrv_col = esc_attr(get_theme_mod('footer_scrolltopbghrv_col','#FBFA02'));
	...
	<style type="text/css">
		...
		.main-header .navbar .navbar-menu ul li a {
			color: <?php echo apply_filters('bakerystore_header', $header_menucolor); ?>;
		}

		.main-header .navbar .navbar-nav > li:hover a {
			color: <?php echo apply_filters('bakerystore_header', $header_menuhovercolor); ?>;
		}

		.main-header .navbar .navbar-menu ul li.dropdown>a::after {
			color: <?php echo apply_filters('bakerystore_header', $header_menuarrowcolor); ?>;
		}

		.main-header .navbar .navbar-menu ul li.dropdown .sub-menu a:not(.remove) {
			color: <?php echo apply_filters('bakerystore_header', $header_submenucolor); ?>;
		}

		.main-header .navbar .navbar-menu ul li.dropdown .sub-menu a:hover {
			color: <?php echo apply_filters('bakerystore_header', $header_submenuhovercolor); ?> !important;
		}

		.main-header .navbar .navbar-menu ul li.dropdown .sub-menu {
			background: <?php echo apply_filters('bakerystore_header', $header_submenubgcolor); ?>;
		}

		.main-header .navbar .navbar-menu ul li.dropdown .sub-menu {
			outline-color: <?php echo apply_filters('bakerystore_header', $header_submenubordercolor); ?>;
		}
		...
		.hero-slider .swiper-pagination-bullet {
			background: <?php echo apply_filters('bakerystore_slider', $slider_slidebarcolor); ?>;
		}

		.hero-slider .swiper-pagination-bullet-active {
			background: <?php echo apply_filters('bakerystore_slider', $slider_slidebaractivecolor); ?>;
		}
		...
		.footer-area svg path {
			fill: <?php echo apply_filters('bakerystore_footer', $footer_bg_col); ?> !important;
		}

		.footer-area .footer-top,.copy-right {
			background: <?php echo apply_filters('bakerystore_footer', $footer_bg_col); ?>;
		}

		.footer-area .widget_block h1, .footer-area .widget_block h2, .footer-area .widget_block h3, .footer-area .widget_block h4, .footer-area .widget_block h5, .footer-area .widget_block h6 {
			color: <?php echo apply_filters('bakerystore_footer', $footer_heading_col); ?>;
		}

		.footer-area .widget_text, .footer-area .widget_text p {
			color: <?php echo apply_filters('bakerystore_footer', $footer_text_col); ?>;
		}

		.footer-area .footer-widget .widget:not(.widget_social_widget):not(.widget_tag_cloud) li a {
			color: <?php echo apply_filters('bakerystore_footer', $footer_list_col); ?>;
		}

		.footer-area .footer-widget .widget:not(.widget_social_widget):not(.widget_tag_cloud) li:before {
			color: <?php echo apply_filters('bakerystore_footer', $footer_icon_col); ?>;
		}

		.footer-area .footer-widget .widget:not(.widget_social_widget):not(.widget_tag_cloud) li a:hover {
			color: <?php echo apply_filters('bakerystore_footer', $footer_listhover_col); ?>;
		}

		.copy-right p {
			color: <?php echo apply_filters('bakerystore_footer', $footer_copyright_col); ?>;
		}

		.copy-right p a {
			color: <?php echo apply_filters('bakerystore_footer', $footer_copyrightlink_col); ?>;
		}

		.footer-area .content {
			border-bottom-color: <?php echo apply_filters('bakerystore_footer', $footer_topborder_col); ?>;
		}

		.scroll-top {
			color: <?php echo apply_filters('bakerystore_footer', $footer_scrolltoparrow_col); ?>;
		}

		.scroll-top {
			background: <?php echo apply_filters('bakerystore_footer', $footer_scrolltopbg_col); ?>;
		}

		.scroll-top:hover {
			background: <?php echo apply_filters('bakerystore_footer', $footer_scrolltopbghrv_col); ?>;
		}
