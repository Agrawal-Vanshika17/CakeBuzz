...
function vw_bakery_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_bakery_header_background_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_bakery_header_background_color', array(
		'label'    => __('Header Background Color', 'vw-bakery'),
	...
	//Menus Settings
	$wp_customize->add_section( 'vw_bakery_menu_section' , array(
    	'title' => __( 'Menus Settings', 'vw-bakery' ),
		'panel' => 'vw_bakery_homepage_panel',
		'priority'   => 3,
	) );
	...
	$wp_customize->add_control('vw_bakery_navigation_menu_font_size',array(
		...
		'section'=> 'vw_bakery_menu_section',
		'type'=> 'text'
	));
	...
	$wp_customize->add_control('vw_bakery_navigation_menu_font_weight',array(
        ...
        'section' => 'vw_bakery_menu_section',
        'choices' => array(
        	'100' => __('100','vw-bakery'),
            '200' => __('200','vw-bakery'),
            '300' => __('300','vw-bakery'),
            '400' => __('400','vw-bakery'),
            '500' => __('500','vw-bakery'),
            '600' => __('600','vw-bakery'),
            '700' => __('700','vw-bakery'),
            '800' => __('800','vw-bakery'),
            '900' => __('900','vw-bakery'),
        ),
	) );

	// text trasform
	$wp_customize->add_setting('vw_bakery_menu_text_transform',array(
		'default'=> 'Uppercase',
		'sanitize_callback'	=> 'vw_bakery_sanitize_choices'
	));
	$wp_customize->add_control('vw_bakery_menu_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Menus Text Transform','vw-bakery'),
		'choices' => array(
	...
	$wp_customize->add_control('vw_bakery_menus_item_style',array(
        'type' => 'select',
        'section' => 'vw_bakery_menu_section',
		'label' => __('Menus Item Hover Style','vw-bakery'),
		'choices' => array(
   ...
   $wp_customize->add_setting('vw_bakery_slider_image_overlay_color', array(
	...
	$wp_customize->add_setting( 'vw_bakery_footer_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_bakery_switch_sanitization'
    ));
    $wp_customize->add_control( new vw_bakery_Toggle_Switch_Custom_Control( $wp_customize, 'vw_bakery_footer_hide_show',array(
      'label' => esc_html__( 'Show / Hide Footer','vw-bakery' ),
	...
	// Footer
	$wp_customize->add_setting('vw_bakery_img_footer',array(
		'default'=> 'scroll',
		'sanitize_callback'	=> 'vw_bakery_sanitize_choices'
	));
	$wp_customize->add_control('vw_bakery_img_footer',array(
		'type' => 'select',
		'label'	=> __('Footer Background Attatchment','vw-bakery'),
		'choices' => array(
            'fixed' => __('fixed','vw-bakery'),
            'scroll' => __('scroll','vw-bakery'),
        ),
		'section'=> 'vw_bakery_footer',
	));
	...
	$wp_customize->add_setting( 'vw_bakery_copyright_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_bakery_switch_sanitization'
    ));
    $wp_customize->add_control( new vw_bakery_Toggle_Switch_Custom_Control( $wp_customize, 'vw_bakery_copyright_hide_show',array(
      'label' => esc_html__( 'Show / Hide Copyright','vw-bakery' ),
      'section' => 'vw_bakery_footer'
    )));

	$wp_customize->add_setting('vw_bakery_copyright_background_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_bakery_copyright_background_color', array(
		'label'    => __('Copyright Background Color', 'vw-bakery'),
		'section'  => 'vw_bakery_footer',
	)));
  ...
  $wp_customize->add_control('vw_bakery_blog_post_featured_image_dimension',array(
	...
	$wp_customize->add_section( 'vw_bakery_single_blog_settings', array(
  	...
  	$wp_customize->add_setting('vw_bakery_single_postdate_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new vw_bakery_Fontawesome_Icon_Chooser(
        $wp_customize,'vw_bakery_single_postdate_icon',array(
		'label'	=> __('Add Post Date Icon','vw-bakery'),
		'transport' => 'refresh',
		'section'	=> 'vw_bakery_single_blog_settings',
		'setting'	=> 'vw_bakery_single_postdate_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('vw_bakery_single_author_icon',array(
		'default'	=> 'fas fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new vw_bakery_Fontawesome_Icon_Chooser(
        $wp_customize,'vw_bakery_single_author_icon',array(
		'label'	=> __('Add Author Icon','vw-bakery'),
		'transport' => 'refresh',
		'section'	=> 'vw_bakery_single_blog_settings',
		'setting'	=> 'vw_bakery_single_author_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('vw_bakery_single_comments_icon',array(
		'default'	=> 'fa fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new vw_bakery_Fontawesome_Icon_Chooser(
        $wp_customize,'vw_bakery_single_comments_icon',array(
		'label'	=> __('Add Comments Icon','vw-bakery'),
		'transport' => 'refresh',
		'section'	=> 'vw_bakery_single_blog_settings',
		'setting'	=> 'vw_bakery_single_comments_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_control( new VW_Bakery_Toggle_Switch_Custom_Control( $wp_customize, 'vw_bakery_single_comments',array(
  	...
  	$wp_customize->add_setting('vw_bakery_single_time_icon',array(
		'default'	=> 'far fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new vw_bakery_Fontawesome_Icon_Chooser(
        $wp_customize,'vw_bakery_single_time_icon',array(
		'label'	=> __('Add Time Icon','vw-bakery'),
		'transport' => 'refresh',
		'section'	=> 'vw_bakery_single_blog_settings',
		'setting'	=> 'vw_bakery_single_time_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_section( 'vw_bakery_grid_layout_settings', array(
  	...
  	$wp_customize->add_setting('vw_bakery_grid_postdate_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new vw_bakery_Fontawesome_Icon_Chooser(
        $wp_customize,'vw_bakery_grid_postdate_icon',array(
		'label'	=> __('Add Post Date Icon','vw-bakery'),
		'transport' => 'refresh',
		'section'	=> 'vw_bakery_grid_layout_settings',
		'setting'	=> 'vw_bakery_grid_postdate_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('vw_bakery_grid_author_icon',array(
		'default'	=> 'fas fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new vw_bakery_Fontawesome_Icon_Chooser(
        $wp_customize,'vw_bakery_grid_author_icon',array(
		'label'	=> __('Add Author Icon','vw-bakery'),
		'transport' => 'refresh',
		'section'	=> 'vw_bakery_grid_layout_settings',
		'setting'	=> 'vw_bakery_grid_author_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('vw_bakery_grid_comments_icon',array(
		'default'	=> 'fa fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new vw_bakery_Fontawesome_Icon_Chooser(
        $wp_customize,'vw_bakery_grid_comments_icon',array(
		'label'	=> __('Add Comments Icon','vw-bakery'),
		'transport' => 'refresh',
		'section'	=> 'vw_bakery_grid_layout_settings',
		'setting'	=> 'vw_bakery_grid_comments_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('vw_bakery_preloader_bg_img',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'vw_bakery_preloader_bg_img',array(
        'label' => __('Preloader Background Image','vw-bakery'),
        'section' => 'vw_bakery_left_right'
	)));
	...
	$wp_customize->add_setting( 'vw_bakery_shop_featured_image_border_radius', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_bakery_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_bakery_shop_featured_image_border_radius', array(
		'label'       => esc_html__( 'Shop Page Featured Image Border Radius','vw-bakery' ),
	...
	$wp_customize->add_setting( 'vw_bakery_shop_featured_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_bakery_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_bakery_shop_featured_image_box_shadow', array(
		'label'       => esc_html__( 'Shop Page Featured Image Box Shadow','vw-bakery' ),
		'section'     => 'vw_bakery_woocommerce_section',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
