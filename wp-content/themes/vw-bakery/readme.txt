...
* Remove button text-decoration: underline from block pattern.
...
= 0.9.9 =
* Added woocommerce products button padding option in customizer.
* Updated language folder.
...
= 1.2.2 =
* Added css for block pattern in responsive.
...
= 1.2.9 =
* Done about us widget css in sidebar and footer.
...
= 1.3.2 =
* Remove default menus color in customizer.
* Remove default toggle btn color in customizer.

= 1.3.3 =
* Added go pro button in footer section in customizer.
...
* Added blog page button font size, text transform option in customizer.
* Updated language folder.
...
* Resolved css error for logo. 
* Resolved css error for blog page. 
